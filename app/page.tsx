  ...
  return (
    <>
      ...
      <main className=" max-w-3xl mx-auto p-5 space-y-5 mt-20">
        ...
        <p className="text-3xl font-bold">Take control of your <span className="text-amber-500">finances</span></p>
        <p className="text-lg">Master your finances with our Expense Manager. Simplify the management of your income and expenses in one place, intuitively and efficiently. Take full control of your personal or business finances with our easy-to-use platform.</p>
        ...
        <ol className="grid grid-cols-1 gap-5 items-start">
          <li className="p-5 shadow-lg text-lg">
            ...
            Categorize and view your expenses clearly and neatly, hassle-free with our friendly and easy-to-use dashboard.
          </li>
          <li className="p-5 shadow-lg text-lg">
          ...
          <li className="p-5 shadow-lg text-lg">
            ...
            Our platform is available so you can manage your finances wherever you are.
          </li>
          <li className="p-5 shadow-lg text-lg">
